...
import 'package:gg/printer_provider.dart';

class printter_component extends StatefulWidget {
  const printter_component({super.key});

  @override
  State<printter_component> createState() => _printter_componentState();
}

class _printter_componentState extends State<printter_component> {
  @override
